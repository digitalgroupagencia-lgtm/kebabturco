-- PIN de cobrança criado pelo próprio vendedor no primeiro acesso.
...
BEGIN
  ...
  VALUES (
    ...
    auth.uid(),
    v_user_role_id,
    extensions.crypt(trim(_pin), extensions.gen_salt('bf'))
  )
...
SELECT 'seller_self_access_pin OK' AS status;
