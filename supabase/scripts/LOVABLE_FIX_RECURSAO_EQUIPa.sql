-- URGENTE: colar na Lovable (SQL Editor) e executar UMA vez
-- Corrige erro "infinite recursion" ao criar equipa e ecrã de erro no painel
...
SELECT 'Equipa: políticas corrigidas — pode criar membros' AS resultado;
