-- Executar no SQL Editor do Lovable/Supabase se o checkout disser
-- "Recebimentos online ainda não estão activos para este restaurante."

-- 1) Permite ao totem (cliente anónimo) ler estado Stripe da loja
...
-- 2) Liga Gandia à conta Stripe Connect live
