...
-- Inscreve cliente na fase boas-vindas na primeira encomenda.
CREATE OR REPLACE FUNCTION public.enroll_customer_marketing_lifecycle()
RETURNS trigger
LANGUAGE plpgsql
SECURITY DEFINER
...
CREATE TRIGGER trg_enroll_customer_lifecycle
  AFTER INSERT ON public.customer_first_orders
  FOR EACH ROW
  EXECUTE FUNCTION public.enroll_customer_marketing_lifecycle();
