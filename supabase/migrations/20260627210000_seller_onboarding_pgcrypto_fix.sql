-- Vendedor: perfil + PIN (complemento se a função SQL ainda não existir na base).
-- A app usa também a função edge seller-complete-onboarding (não depende de gen_salt).
