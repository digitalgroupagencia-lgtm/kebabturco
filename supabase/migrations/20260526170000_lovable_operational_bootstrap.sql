-- Bootstrap operacional idempotente (QR mesas, pagamentos, impressão, caixa, diagnóstico)
-- Aplicado automaticamente pela Lovable ao correr migrations pendentes.
-- Política de pagamento por tipo de pedido + QR token de mesa
