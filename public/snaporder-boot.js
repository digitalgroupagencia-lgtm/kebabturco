(function () {
  ...
  function showBootError(message) {
    ...
    if (!el) return;
    el.innerHTML =
      '<div style="min-height:100dvh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;text-align:center;font-family:system-ui,sans-serif;color:#fff;background:#5C1419">' +
      ...
      message +
      "</p>" +
      '<button type="button" id="boot-reload-btn" style="background:#fff;color:#5C1419;border:none;border-radius:999px;padding:12px 24px;font-weight:700;font-size:14px">Actualizar</button>' +
      "</div>";
