...
const translations: Translations = {
  ...
  addressFloor: { pt: "Piso", en: "Floor", es: "Piso", fr: "Étage" },
  addressFloorPh: { pt: "Ex: 3 ou 3º", en: "Ex: 3 or 3rd", es: "Ej: 3 o 3º", fr: "Ex : 3 ou 3e" },
  addressDoor: { pt: "Porta", en: "Door", es: "Puerta", fr: "Porte" },
  addressDoorPh: { pt: "Ex: B ou 12", en: "Ex: B or 12", es: "Ej: B o 12", fr: "Ex : B ou 12" },
  addressFloorDoorHint: {
    pt: "Opcional — importante em prédios",
    en: "Optional — important for apartments",
    es: "Opcional — importante en edificios",
    fr: "Facultatif — important en immeuble",
  },
