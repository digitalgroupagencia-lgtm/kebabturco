...
const translations: Translations = {
  ...
  localDeviceOrdersTitle: {
    pt: "Pedidos neste telemóvel",
    en: "Orders on this phone",
    es: "Pedidos en este móvil",
    fr: "Commandes sur ce téléphone",
  },
  orderStatusPending: { pt: "Recebido", en: "Received", es: "Recibido", fr: "Reçu" },
  orderStatusPreparing: { pt: "A preparar", en: "Preparing", es: "En preparación", fr: "En préparation" },
  orderStatusReady: { pt: "Pronto", en: "Ready", es: "Listo", fr: "Prêt" },
  orderStatusDelivered: { pt: "Entregue", en: "Delivered", es: "Entregado", fr: "Livré" },
  orderStatusCancelled: { pt: "Cancelado", en: "Cancelled", es: "Cancelado", fr: "Annulé" },
  loyaltyTitle: { pt: "Fidelidade", en: "Loyalty", es: "Fidelidad", fr: "Fidélité" },
  loyaltyStamps: {
    pt: "{current} / {needed} carimbos",
    en: "{current} / {needed} stamps",
    es: "{current} / {needed} sellos",
    fr: "{current} / {needed} tampons",
  },
  loyaltyRewardReady: {
  ...
  noOrdersForPhone: {
    pt: "Nenhum pedido encontrado para este número",
    en: "No orders found for this number",
    es: "Ningún pedido encontrado para este número",
    fr: "Aucune commande pour ce numéro",
  },
  reorderFromHistory: {
    pt: "Pedir de novo",
    en: "Order again",
  ...
  reorderProductsUnavailable: {
    pt: "Os produtos deste pedido já não estão disponíveis.",
    en: "Products from this order are no longer available.",
    es: "Los productos de este pedido ya no están disponibles.",
    fr: "Les produits de cette commande ne sont plus disponibles.",
  },
  reorderProductsAdded: {
    pt: "Produtos adicionados ao carrinho",
    en: "Products added to cart",
    es: "Productos añadidos al carrito",
    fr: "Produits ajoutés au panier",
  },
