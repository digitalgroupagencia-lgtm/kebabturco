    ...
    >
      <div className={`relative flex h-full w-full min-h-0 flex-col overflow-hidden ${PHONE_BEZEL}`}>
        <div
          ...
          aria-hidden
        />
        <div className="relative flex h-full min-h-0 w-full flex-1 flex-col overflow-y-auto overflow-x-hidden [@media(hover:hover)_and_(pointer:fine)]:rounded-[2.3rem] [@media(hover:hover)_and_(pointer:fine)]:bg-background">
