...
export const ROUTE_MAP_SECTIONS: RouteMapSection[] = [
  {
    ...
    routes: [
      ...
      },
      {
        path: "/kebab-turco",
        label: "Loja por slug",
        description: "Mesma loja; útil no preview e localhost.",
        role: "Público",
        active: true,
        kind: "real",
      },
      {
        ...
        label: "Prévia embebida",
        description: "Loja em modo prévia.",
        role: "Público",
        active: true,
        kind: "real",
      },
      {
        path: "/preview/kebab-turco?preview=1&tenant=kebab-turco&screen=home",
      ...
      {
        path: "/preview/kebab-turco?preview=1&tenant=kebab-turco&screen=product&productId=ID",
      ...
      {
        path: "/preview/kebab-turco?preview=1&tenant=kebab-turco&screen=payment&seedCheckout=1",
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: "/panel/*",
        label: "Wildcard painel",
        description: "Padrão do router — NÃO é página clicável no preview Lovable.",
        role: "—",
        active: true,
        kind: "wildcard",
        note: "Use rotas reais abaixo, ex.: /panel/menu",
      },
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        description: "Padrão do router — NÃO é página real. O selector Lovable mostra isto por engano.",
        role: "—",
        active: true,
        kind: "wildcard",
        note: "Se abrir literalmente, redirecciona para /admin com aviso.",
      },
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: "/seller/*",
        label: "Wildcard vendedor",
        description: "Padrão do router — não clicável no preview.",
        role: "—",
        active: true,
        kind: "wildcard",
      },
  ...
  },
  {
    ...
    routes: [
      { path: "/admin/tenants", label: "Clientes (SnapOrder)", description: "Redirecciona → /admin.", role: "—", active: false, kind: "legacy" },
      { path: "/admin/tenants/:slug", label: "Workspace tenant", description: "Código existe mas rota desligada.", role: "—", active: false, kind: "legacy" },
