...
/** Rotas internas — separado de navPaths para o ecrã do cliente não puxar o painel. */
export const INTERNAL_ROUTE_TABLE: readonly RouteSegmentDef[] = [
  ...
  { area: "admin", segments: ["live-activity"], loader: () => import("@/views/admin/LiveActivitySettingsPage.tsx") },
  ...
  { area: "admin", segments: ["visit-print"], loader: () => import("@/views/admin/AdminVisitPrintPage.tsx") },
