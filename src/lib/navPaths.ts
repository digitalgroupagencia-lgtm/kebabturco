...
export const INTERNAL_ROUTE_TABLE: readonly RouteSegmentDef[] = [
  ...
  { area: "panel", segments: ["modifiers"], loader: () => import("@/views/panel/ModifierGroupsPage.tsx") },
  { area: "panel", segments: ["orders"], loader: () => import("@/views/panel/OrdersPage.tsx") },
  ...
  { area: "panel", segments: ["stock"], loader: () => import("@/views/panel/StockPage.tsx") },
  { area: "panel", segments: ["reports"], loader: () => import("@/views/panel/ReportsPage.tsx") },
  ...
  { area: "panel", segments: ["totem"], loader: () => import("@/views/panel/TotemConfigPage.tsx") },
  { area: "panel", segments: ["tables"], loader: () => import("@/views/panel/TablesPage.tsx") },
  { area: "panel", segments: ["printers"], loader: () => import("@/views/admin/PrinterPage.tsx") },
  ...
  { area: "panel", segments: ["branding"], loader: () => import("@/views/admin/BrandingPage.tsx") },
  { area: "panel", segments: ["banners"], loader: () => import("@/views/admin/BannerPage.tsx") },
  { area: "panel", segments: ["stores"], loader: () => import("@/views/admin/tenant/TenantStoresPage.tsx") },
  { area: "panel", segments: ["screens"], loader: () => import("@/views/admin/tenant/TenantScreensPage.tsx") },
  { area: "panel", segments: ["languages"], loader: () => import("@/views/admin/tenant/TenantLanguagesPage.tsx") },
  { area: "panel", segments: ["delivery-zones"], loader: () => import("@/views/admin/tenant/TenantDeliveryZonesPage.tsx") },
  { area: "panel", segments: ["payments"], loader: () => import("@/views/admin/OperationsPage.tsx") },
  ...
  { area: "panel", segments: ["coupons"], loader: () => import("@/views/panel/CouponsPage.tsx") },
  { area: "panel", segments: ["loyalty"], loader: () => import("@/views/panel/LoyaltyPage.tsx") },
