...
export const INTERNAL_ROUTE_TABLE: readonly RouteSegmentDef[] = [
  ...
  { area: "panel", segments: ["customer-feedback"], loader: () => import("@/views/panel/CustomerFeedbackPage.tsx") },
  ...
  { area: "admin", segments: ["diagnostics"], loader: () => import("@/views/panel/DiagnosticsPage.tsx") },
  { area: "admin", segments: ["diagnostics-hub"], loader: () => import("@/views/admin/DiagnosticsHubPage.tsx") },
  { area: "admin", segments: ["push-test"], loader: () => import("@/views/admin/PushTestPage.tsx") },
  { area: "admin", segments: ["order-simulator"], loader: () => import("@/views/admin/OrderSimulatorPage.tsx") },
  ...
  { area: "admin", segments: ["conexoes"], loader: () => import("@/views/admin/AdminConnectionsPage.tsx") },
  { area: "admin", segments: ["wgm-bridge"], loader: () => import("@/views/admin/AdminWgmBridgePage.tsx") },
  { area: "admin", segments: ["demo-visita"], loader: () => import("@/views/admin/AdminVisitPrintPage.tsx") },
